...
#		These 15 loads should hit LFB	
		...
		movsd		32(%rsi, %r9,1), %xmm8
		movsd		32(%rsi, %r9,1), %xmm9
		...
		movsd		32(%rsi, %r9,1), %xmm3
		movsd		32(%rsi, %r9,1), %xmm4
		movsd		32(%rsi, %r9,1), %xmm4
...
#		These 15 loads should hit LFB	
		...
		movsd		32(%rcx, %r9,1), %xmm8
		movsd		32(%rcx, %r9,1), %xmm9
		...
		movsd		32(%rcx, %r9,1), %xmm3
		movsd		32(%rcx, %r9,1), %xmm4
		movsd		32(%rcx, %r9,1), %xmm4
...
#		These 15 loads should hit LFB	
		...
		movsd		32(%r8, %r9,1), %xmm7
		movsd		32(%r8, %r9,1), %xmm8
		movsd		32(%r8, %r9,1), %xmm9
		movsd		(%r8, %r9,1), %xmm10
		movsd		(%r8, %r9,1), %xmm11
		movsd		(%r8, %r9,1), %xmm12
		movsd		(%r8, %r9,1), %xmm13
		movsd		32(%r8, %r9,1), %xmm14
		movsd		32(%r8, %r9,1), %xmm15
		movsd		32(%r8, %r9,1), %xmm3
		movsd		32(%r8, %r9,1), %xmm4
