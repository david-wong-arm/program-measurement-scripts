...
unsigned long long scale_ (unsigned long long, struct item*, int); // Using David Wong's 'in codelet' repetitions
unsigned long long scale1_ (unsigned long long, struct item*, int); // Using David Wong's 'in codelet' repetitions
...
//	rdtscll (before);
	nb_iters = scale1_ (inner_rep, (struct item*)(alignedMem), 1);
