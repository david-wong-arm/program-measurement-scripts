...
# %r13 (saved below and restored at the end) <- chain 9
# %r14 (saved below and restored at the end) <- chain 10
# %r15 (saved below and restored at the end) <- chain 11
...
#	sub $32, %rsp
	...
	movq	glo_p8(%rip), %r12
	movq	glo_p9(%rip), %r13
	movq	glo_p10(%rip), %r14
	movq	glo_p11(%rip), %r15
