...
//	mem = malloc (alignedSize);
	...
	makeStridedList(alignedMem, nb_elements_per_list,3, nb_elements, shuffle);
	makeStridedList(alignedMem1, nb_elements_per_list,3, nb_elements, shuffle);
	makeStridedList(alignedMem2, nb_elements_per_list,3, nb_elements, shuffle);
#else
	...
	makeList(alignedMem2, nb_elements_per_list,1, nb_elements);
