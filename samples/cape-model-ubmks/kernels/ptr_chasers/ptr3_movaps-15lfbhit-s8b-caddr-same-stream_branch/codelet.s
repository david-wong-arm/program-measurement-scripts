...
#		These 15 loads should hit LFB	
		movsd		8(%rsi,%r9,1), %xmm3
		movsd		16(%rsi,%r9,1), %xmm4
		movsd		24(%rsi,%r9,1), %xmm5
		movsd		32(%rsi,%r9,1), %xmm6
		movsd		40(%rsi,%r9,1), %xmm7
		movsd		48(%rsi, %r9,1), %xmm8
		movsd		56(%rsi, %r9,1), %xmm9
		movsd		(%rsi, %r9,1), %xmm10
		movsd		8(%rsi, %r9,1), %xmm11
		movsd		16(%rsi, %r9,1), %xmm12
		movsd		24(%rsi, %r9,1), %xmm13
		movsd		32(%rsi, %r9,1), %xmm14
		movsd		40(%rsi, %r9,1), %xmm15
		movsd		48(%rsi, %r9,1), %xmm3
		movsd		56(%rsi, %r9,1), %xmm4

		movq		%xmm0, %rsi
	
		movsd		(%rcx, %r9,1), %xmm1
#		These 15 loads should hit LFB	
		movsd		8(%rcx, %r9,1), %xmm3
		movsd		16(%rcx, %r9,1), %xmm4
		movsd		24(%rcx, %r9,1), %xmm5
		movsd		32(%rcx, %r9,1), %xmm6
		movsd		40(%rcx, %r9,1), %xmm7
		movsd		48(%rcx, %r9,1), %xmm8
		movsd		56(%rcx, %r9,1), %xmm9
		movsd		(%rcx, %r9,1), %xmm10
		movsd		8(%rcx, %r9,1), %xmm11
		movsd		16(%rcx, %r9,1), %xmm12
		movsd		24(%rcx, %r9,1), %xmm13
		movsd		32(%rcx, %r9,1), %xmm14
		movsd		40(%rcx, %r9,1), %xmm15
		movsd		48(%rcx, %r9,1), %xmm3
		movsd		56(%rcx, %r9,1), %xmm4
		...
		movsd		(%r8, %r9,1), %xmm2
#		These 15 loads should hit LFB	
		movsd		8(%r8, %r9,1), %xmm3
		movsd		16(%r8, %r9,1), %xmm4
		movsd		24(%r8, %r9,1), %xmm5
		movsd		32(%r8, %r9,1), %xmm6
		movsd		40(%r8, %r9,1), %xmm7
		movsd		48(%r8, %r9,1), %xmm8
		movsd		56(%r8, %r9,1), %xmm9
		movsd		(%r8, %r9,1), %xmm10
		movsd		8(%r8, %r9,1), %xmm11
		movsd		16(%r8, %r9,1), %xmm12
		movsd		24(%r8, %r9,1), %xmm13
		movsd		32(%r8, %r9,1), %xmm14
		movsd		40(%r8, %r9,1), %xmm15
		movsd		48(%r8, %r9,1), %xmm3
		movsd		56(%r8, %r9,1), %xmm4
