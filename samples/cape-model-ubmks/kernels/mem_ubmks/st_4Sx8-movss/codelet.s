...
#	add $8, %rsi
	...
	.L6:
		...
		movss %xmm4, 16(%rsi,%r8,8)
		movss %xmm4, 16(%rsi,%r12,8)
		movss %xmm4, 16(%rsi,%r13,8)

        movss %xmm5, 20(%rsi,%r9,8)
        movss %xmm5, 20(%rsi,%r8,8)
        movss %xmm5, 20(%rsi,%r12,8)
        movss %xmm5, 20(%rsi,%r12,8)

        movss %xmm6, 24(%rsi,%r9,8)
        movss %xmm6, 24(%rsi,%r8,8)
        movss %xmm6, 24(%rsi,%r12,8)
        movss %xmm6, 24(%rsi,%r13,8)

        movss %xmm7, 28(%rsi,%r9,8)
        movss %xmm7, 28(%rsi,%r8,8)
        movss %xmm7, 28(%rsi,%r12,8)
        movss %xmm7, 28(%rsi,%r13,8)
