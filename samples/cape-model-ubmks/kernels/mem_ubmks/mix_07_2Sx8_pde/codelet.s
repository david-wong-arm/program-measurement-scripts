...
#	add $8, %rsi
	...
	.L6:
		...
		movups %xmm1,  0(%rsi,%r9,8)
		movups %xmm2,  16(%rsi,%r9,8)
		movups %xmm3,  32(%rsi,%r9,8)
		movups %xmm4,  48(%rsi,%r9,8)	
		movups %xmm9,  64(%rsi,%r9,8)	
		movups %xmm10, 80(%rsi,%r9,8)	
		movups %xmm11, 96(%rsi,%r9,8)	
		movups %xmm12, 112(%rsi,%r9,8)	
