...
#	add $8, %rsi
	...
	.L6:
		...
		vmovaps 0(%rsi,%r9,8), %xmm0
		vmovaps 32(%rsi,%r9,8), %xmm1
		vmovaps 64(%rsi,%r9,8), %xmm2
		vmovaps 96(%rsi,%r9,8), %xmm3
		vmovaps 128(%rsi,%r9,8), %xmm4
		vmovaps 160(%rsi,%r9,8), %xmm5
		vmovaps 192(%rsi,%r9,8), %xmm6
		vmovaps 224(%rsi,%r9,8), %xmm7
