...
#	add $8, %rsi
	...
	.L6:
		...
		vmovups 160(%rsi,%r9,8), %ymm10
		vmovups 192(%rsi,%r9,8), %ymm11
		vmovups 224(%rsi,%r9,8), %ymm12
		...
		vmovups 128(%rsi,%r8,8), %ymm13
		vsubpd  %ymm13, %ymm9, %ymm9
		vmovups 160(%rsi,%r8,8), %ymm14
		...
		vmovups %ymm1,  0(%rsi,%r9,8)
		vmovups %ymm2,  32(%rsi,%r9,8)
		vmovups %ymm3,  64(%rsi,%r9,8)
		vmovups %ymm4,  96(%rsi,%r9,8)	
		vmovups %ymm9,  128(%rsi,%r9,8)	
		vmovups %ymm10, 160(%rsi,%r9,8)	
		vmovups %ymm11, 192(%rsi,%r9,8)	
		vmovups %ymm12, 224(%rsi,%r9,8)	
