...
#	add $8, %rsi
	...
	.L6:
		...
		movss %xmm0, 16(%rsi,%r9,8)
		movss %xmm0, 16(%rsi,%r8,8)

		movss %xmm1, 20(%rsi,%r9,8)
		movss %xmm1, 20(%rsi,%r8,8)

		movss %xmm2, 24(%rsi,%r9,8)
		movss %xmm2, 24(%rsi,%r8,8)

		movss %xmm3, 28(%rsi,%r9,8)
		movss %xmm3, 28(%rsi,%r8,8)
