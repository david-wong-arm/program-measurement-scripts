...
#	add $8, %rsi
	...
	.L6:
		...
		movsd 0(%rsi,%r12,8), %xmm0
		movsd 0(%rsi,%r13,8), %xmm0

		movsd 8(%rsi,%r9,8), %xmm1
		movsd 8(%rsi,%r8,8), %xmm1
		movsd 8(%rsi,%r12,8), %xmm1
		movsd 8(%rsi,%r13,8), %xmm1

		movsd 16(%rsi,%r9,8), %xmm2
		movsd 16(%rsi,%r8,8), %xmm2
		movsd 16(%rsi,%r12,8), %xmm2
		movsd 16(%rsi,%r13,8), %xmm2

		movsd 24(%rsi,%r9,8), %xmm3
		movsd 24(%rsi,%r8,8), %xmm3
		movsd 24(%rsi,%r12,8), %xmm3
		movsd 24(%rsi,%r13,8), %xmm3

		movsd 32(%rsi,%r9,8), %xmm4
		movsd 32(%rsi,%r8,8), %xmm4
		movsd 32(%rsi,%r12,8), %xmm4
		movsd 32(%rsi,%r13,8), %xmm4

        movsd 40(%rsi,%r9,8), %xmm5
        movsd 40(%rsi,%r8,8), %xmm5
        movsd 40(%rsi,%r12,8), %xmm5
        movsd 40(%rsi,%r12,8), %xmm5

        movsd 48(%rsi,%r9,8), %xmm6
        movsd 48(%rsi,%r8,8), %xmm6
        movsd 48(%rsi,%r12,8), %xmm6
        movsd 48(%rsi,%r13,8), %xmm6

        movsd 56(%rsi,%r9,8), %xmm7
        movsd 56(%rsi,%r8,8), %xmm7
        movsd 56(%rsi,%r12,8), %xmm7
        movsd 56(%rsi,%r13,8), %xmm7
