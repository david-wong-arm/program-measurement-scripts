...
#	add $8, %rsi
	...
	.L6:
		...
		movsd %xmm0, 0(%rsi,%r8,8)
		movsd %xmm0, 0(%rsi,%r12,8)
		movsd %xmm0, 0(%rsi,%r13,8)

		movsd %xmm1, 8(%rsi,%r9,8)
		movsd %xmm1, 8(%rsi,%r8,8)
		movsd %xmm1, 8(%rsi,%r12,8)
		movsd %xmm1, 8(%rsi,%r13,8)

		movsd %xmm2, 16(%rsi,%r9,8)
		movsd %xmm2, 16(%rsi,%r8,8)
		movsd %xmm2, 16(%rsi,%r12,8)
		movsd %xmm2, 16(%rsi,%r13,8)

		movsd %xmm3, 24(%rsi,%r9,8)
		movsd %xmm3, 24(%rsi,%r8,8)
		movsd %xmm3, 24(%rsi,%r12,8)
		movsd %xmm3, 24(%rsi,%r13,8)

		movsd %xmm4, 32(%rsi,%r9,8)
		movsd %xmm4, 32(%rsi,%r8,8)
		movsd %xmm4, 32(%rsi,%r12,8)
		movsd %xmm4, 32(%rsi,%r13,8)

        movsd %xmm5, 40(%rsi,%r9,8)
        movsd %xmm5, 40(%rsi,%r8,8)
        movsd %xmm5, 40(%rsi,%r12,8)
        movsd %xmm5, 40(%rsi,%r12,8)

        movsd %xmm6, 48(%rsi,%r9,8)
        movsd %xmm6, 48(%rsi,%r8,8)
        movsd %xmm6, 48(%rsi,%r12,8)
        movsd %xmm6, 48(%rsi,%r13,8)

        movsd %xmm7, 56(%rsi,%r9,8)
        movsd %xmm7, 56(%rsi,%r8,8)
        movsd %xmm7, 56(%rsi,%r12,8)
        movsd %xmm7, 56(%rsi,%r13,8)
