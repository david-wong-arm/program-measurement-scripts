...
.DL1:
	...
	.L6:
		...
		vmovups %ymm0, 0(%rsi,%r12,8)
		vmovups %ymm0, 0(%rsi,%r13,8)

		vmovups %ymm1, 32(%rsi,%r9,8)
		vmovups %ymm1, 32(%rsi,%r8,8)
		vmovups %ymm1, 32(%rsi,%r12,8)
		vmovups %ymm1, 32(%rsi,%r13,8)

		vmovups %ymm2, 64(%rsi,%r9,8)
		vmovups %ymm2, 64(%rsi,%r8,8)
		vmovups %ymm2, 64(%rsi,%r12,8)
		vmovups %ymm2, 64(%rsi,%r13,8)

		vmovups %ymm3, 96(%rsi,%r9,8)
		vmovups %ymm3, 96(%rsi,%r8,8)
		vmovups %ymm3, 96(%rsi,%r12,8)
		vmovups %ymm3, 96(%rsi,%r13,8)

		vmovups %ymm4, 128(%rsi,%r9,8)
		vmovups %ymm4, 128(%rsi,%r8,8)
		vmovups %ymm4, 128(%rsi,%r12,8)
		vmovups %ymm4, 128(%rsi,%r13,8)

        vmovups %ymm5, 160(%rsi,%r9,8)
        vmovups %ymm5, 160(%rsi,%r8,8)
        vmovups %ymm5, 160(%rsi,%r12,8)
        vmovups %ymm5, 160(%rsi,%r12,8)

        vmovups %ymm6, 192(%rsi,%r9,8)
        vmovups %ymm6, 192(%rsi,%r8,8)
        vmovups %ymm6, 192(%rsi,%r12,8)
        vmovups %ymm6, 192(%rsi,%r13,8)

        vmovups %ymm7, 224(%rsi,%r9,8)
        vmovups %ymm7, 224(%rsi,%r8,8)
        vmovups %ymm7, 224(%rsi,%r12,8)
        vmovups %ymm7, 224(%rsi,%r13,8)
