...
.DL1:
	...
	.L6:
		...
		movups %xmm0, 0(%rsi,%r12,8)
		movups %xmm0, 0(%rsi,%r13,8)

		movups %xmm1, 16(%rsi,%r9,8)
		movups %xmm1, 16(%rsi,%r8,8)
		movups %xmm1, 16(%rsi,%r12,8)
		movups %xmm1, 16(%rsi,%r13,8)

		movups %xmm2, 32(%rsi,%r9,8)
		movups %xmm2, 32(%rsi,%r8,8)
		movups %xmm2, 32(%rsi,%r12,8)
		movups %xmm2, 32(%rsi,%r13,8)

		movups %xmm3, 48(%rsi,%r9,8)
		movups %xmm3, 48(%rsi,%r8,8)
		movups %xmm3, 48(%rsi,%r12,8)
		movups %xmm3, 48(%rsi,%r13,8)

		movups %xmm4, 64(%rsi,%r9,8)
		movups %xmm4, 64(%rsi,%r8,8)
		movups %xmm4, 64(%rsi,%r12,8)
		movups %xmm4, 64(%rsi,%r13,8)

		movups %xmm5, 80(%rsi,%r9,8)
		movups %xmm5, 80(%rsi,%r8,8)
		movups %xmm5, 80(%rsi,%r12,8)
		movups %xmm5, 80(%rsi,%r13,8)

		movups %xmm6, 96(%rsi,%r9,8)
		movups %xmm6, 96(%rsi,%r8,8)
		movups %xmm6, 96(%rsi,%r12,8)
		movups %xmm6, 96(%rsi,%r13,8)

		movups %xmm7, 112(%rsi,%r9,8)
		movups %xmm7, 112(%rsi,%r8,8)
		movups %xmm7, 112(%rsi,%r12,8)
		movups %xmm7, 112(%rsi,%r13,8)
