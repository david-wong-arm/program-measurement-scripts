...
#	add $8, %rsi
	...
	.L6:
		...
		movaps 64(%rsi,%r8,8), %xmm1
		movaps 64(%rsi,%r12,8), %xmm1
		movaps 64(%rsi,%r13,8), %xmm1

		movaps 128(%rsi,%r9,8), %xmm2
		movaps 128(%rsi,%r8,8), %xmm2
		movaps 128(%rsi,%r12,8), %xmm2
		movaps 128(%rsi,%r13,8), %xmm2

		movaps 192(%rsi,%r9,8), %xmm3
		movaps 192(%rsi,%r8,8), %xmm3
		movaps 192(%rsi,%r12,8), %xmm3
		movaps 192(%rsi,%r13,8), %xmm3
