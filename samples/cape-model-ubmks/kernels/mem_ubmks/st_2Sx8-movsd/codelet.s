...
#	add $8, %rsi
	...
	.L6:
		...
		movsd %xmm0, 32(%rsi,%r9,8)
		movsd %xmm0, 32(%rsi,%r8,8)

		movsd %xmm1, 40(%rsi,%r9,8)
		movsd %xmm1, 40(%rsi,%r8,8)

		movsd %xmm2, 48(%rsi,%r9,8)
		movsd %xmm2, 48(%rsi,%r8,8)

		movsd %xmm3, 56(%rsi,%r9,8)
		movsd %xmm3, 56(%rsi,%r8,8)
