...
.DL1:
	...
	.L6:
		...
		movups %xmm0, 256(%rsi,%r9,8)
		movups %xmm1, 272(%rsi,%r9,8)
		movups %xmm2, 288(%rsi,%r9,8)
		movups %xmm3, 304(%rsi,%r9,8)
		movups %xmm4, 320(%rsi,%r9,8)
		movups %xmm5, 336(%rsi,%r9,8)
		movups %xmm6, 352(%rsi,%r9,8)
		movups %xmm7, 368(%rsi,%r9,8)
		movups %xmm8, 384(%rsi,%r9,8)
		movups %xmm9, 400(%rsi,%r9,8)
		movups %xmm10, 416(%rsi,%r9,8)
		movups %xmm11, 432(%rsi,%r9,8)
		movups %xmm12, 448(%rsi,%r9,8)
		movups %xmm13, 464(%rsi,%r9,8)
		movups %xmm14, 480(%rsi,%r9,8)
		movups %xmm15, 496(%rsi,%r9,8)
