...
#	add $8, %rsi
	...
	.L6:
		...
		vinsertf128 $1, 0(%rsi,%r9,8), %ymm0, %ymm8
		vinsertf128 $1, 32(%rsi,%r9,8), %ymm1, %ymm9
		vinsertf128 $1, 64(%rsi,%r9,8), %ymm2, %ymm10
		vinsertf128 $1, 96(%rsi,%r9,8), %ymm3, %ymm11
		vinsertf128 $1, 128(%rsi,%r9,8), %ymm4, %ymm12
		vinsertf128 $1, 160(%rsi,%r9,8), %ymm5, %ymm13
		vinsertf128 $1, 192(%rsi,%r9,8), %ymm6, %ymm14
		vinsertf128 $1, 224(%rsi,%r9,8), %ymm7, %ymm15
