...
#	add $8, %rsi
	...
	.L6:
		...
		movaps %xmm0, 0(%rsi,%r8,8)
		movaps %xmm0, 0(%rsi,%r12,8)
		movaps %xmm0, 0(%rsi,%r13,8)

		movaps %xmm1, 16(%rsi,%r9,8)
		movaps %xmm1, 16(%rsi,%r8,8)
		movaps %xmm1, 16(%rsi,%r12,8)
		movaps %xmm1, 16(%rsi,%r13,8)

		movaps %xmm2, 32(%rsi,%r9,8)
		movaps %xmm2, 32(%rsi,%r8,8)
		movaps %xmm2, 32(%rsi,%r12,8)
		movaps %xmm2, 32(%rsi,%r13,8)

		movaps %xmm3, 48(%rsi,%r9,8)
		movaps %xmm3, 48(%rsi,%r8,8)
		movaps %xmm3, 48(%rsi,%r12,8)
		movaps %xmm3, 48(%rsi,%r13,8)

		movaps %xmm4, 64(%rsi,%r9,8)
		movaps %xmm4, 64(%rsi,%r8,8)
		movaps %xmm4, 64(%rsi,%r12,8)
		movaps %xmm4, 64(%rsi,%r13,8)

		movaps %xmm5, 80(%rsi,%r9,8)
		movaps %xmm5, 80(%rsi,%r8,8)
		movaps %xmm5, 80(%rsi,%r12,8)
		movaps %xmm5, 80(%rsi,%r13,8)

		movaps %xmm6, 96(%rsi,%r9,8)
		movaps %xmm6, 96(%rsi,%r8,8)
		movaps %xmm6, 96(%rsi,%r12,8)
		movaps %xmm6, 96(%rsi,%r13,8)

		movaps %xmm7, 112(%rsi,%r9,8)
		movaps %xmm7, 112(%rsi,%r8,8)
		movaps %xmm7, 112(%rsi,%r12,8)
		movaps %xmm7, 112(%rsi,%r13,8)
