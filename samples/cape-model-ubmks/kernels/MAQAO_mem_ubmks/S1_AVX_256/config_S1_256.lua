session = {
   ...
   experiment = {              -- Parameters of the experiment
      rootdir = "S1_256",       -- Target directory for all the experiments, if not set then auto generated
   ...
   memory_bench_spec = {
      ...
      patterns = { "1_L_256_F_U_1", -- 1 load stream, not unrolled
                   "1_L_256_F_U_2", -- 1 load stream, 2x unrolled
		   "1_L_256_F_U_4", -- 1 load stream, 4x unrolled
                   "[1_L,2_L]_256_F_U_1", -- 2 load streams, not unrolled
                   "[1_L,2_L]_256_F_U_2", -- 2 load streams, 2x unrolled
                   "[1_L,2_L]_256_F_U_4", -- 2 load streams, 4x unrolled
                   "[1_L,2_L,3_L]_256_F_U_1", -- 3 load streams, not unrolled
                   "[1_L,2_L,3_L]_256_F_U_2", -- 3 load streams, 2x unrolled
                   "[1_L,2_L,3_L]_256_F_U_4", -- 3 load streams, 4x unrolled
