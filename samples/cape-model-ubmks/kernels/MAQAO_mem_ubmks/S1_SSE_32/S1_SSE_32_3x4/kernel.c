...
#define KERNEL(name) void name (uint64_t nrep, uint64_t niter, void *s1, void *s2, void *s3) { \
      ...
      __asm__ volatile (                                                \
         ...
         "MOVSS 0(%[s2],%[S16B]),%%xmm4\n\t"                           \
         "MOVSS 4(%[s2],%[S16B]),%%xmm5\n\t"                           \
         "MOVSS 8(%[s2],%[S16B]),%%xmm6\n\t"                           \
         "MOVSS 12(%[s2],%[S16B]),%%xmm7\n\t"                          \
         "MOVSS 0(%[s3],%[S16B]),%%xmm8\n\t"                           \
         "MOVSS 4(%[s3],%[S16B]),%%xmm9\n\t"                           \
         "MOVSS 8(%[s3],%[S16B]),%%xmm10\n\t"                          \
         "MOVSS 12(%[s3],%[S16B]),%%xmm11\n\t"                         \
         "ADD $16,%[S16B]\n\t"                                          \
         "SUB $1,%[i]\n\t"                                              \
         "JNE 2b\n\t"                                                   \
         "SUB $1,%[r]\n\t"                                              \
