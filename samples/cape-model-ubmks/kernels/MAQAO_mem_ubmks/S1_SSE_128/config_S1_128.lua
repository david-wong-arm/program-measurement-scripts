session = {
   ...
   experiment = {              -- Parameters of the experiment
      rootdir = "S1_128",       -- Target directory for all the experiments, if not set then auto generated
   ...
   memory_bench_spec = {
      ...
      stride = nil, -- wished (constraint from unroll factor...) loop stride in bytes
      unroll_interleave = false, -- true to iterate over streams before unroll factor

      -- Memory access patterns
      patterns = { "1_L_128_F_U_1", -- 1 load stream, not unrolled
                   "1_L_128_F_U_2", -- 1 load stream, 2x unrolled
		   "1_L_128_F_U_4", -- 1 load stream, 4x unrolled
                   "[1_L,2_L]_128_F_U_1", -- 2 load streams, not unrolled
                   "[1_L,2_L]_128_F_U_2", -- 2 load streams, 2x unrolled
                   "[1_L,2_L]_128_F_U_4", -- 2 load streams, 4x unrolled
                   "[1_L,2_L,3_L]_128_F_U_1", -- 3 load streams, not unrolled
                   "[1_L,2_L,3_L]_128_F_U_2", -- 3 load streams, 2x unrolled
                   "[1_L,2_L,3_L]_128_F_U_4", -- 3 load streams, 4x unrolled
      ...
      streams = {
         { size=15000, label="L1", repw=666666, repm=66, metarep=31 },
         { size=117000, label="L2", repw=85470, repm=8, metarep=31 },
         { size=11000000, label="L3", repw=909, repm=1, metarep=31 },
         { size=141000000, label="RAM", repw=70, repm=1, metarep=31 }
      },
