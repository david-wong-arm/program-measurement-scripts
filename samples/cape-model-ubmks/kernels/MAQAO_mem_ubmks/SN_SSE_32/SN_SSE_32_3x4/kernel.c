...
#define KERNEL(name) void name (uint64_t nrep, uint64_t niter, void *s1, void *s2, void *s3) { \
      ...
      __asm__ volatile (                                                \
         ...
         "MOVSS 0(%[s2],%[S2560B]),%%xmm4\n\t"                          \
         "MOVSS 640(%[s2],%[S2560B]),%%xmm5\n\t"                        \
         "MOVSS 1280(%[s2],%[S2560B]),%%xmm6\n\t"                       \
         "MOVSS 1920(%[s2],%[S2560B]),%%xmm7\n\t"                       \
         "MOVSS 0(%[s3],%[S2560B]),%%xmm8\n\t"                          \
         "MOVSS 640(%[s3],%[S2560B]),%%xmm9\n\t"                        \
         "MOVSS 1280(%[s3],%[S2560B]),%%xmm10\n\t"                      \
         "MOVSS 1920(%[s3],%[S2560B]),%%xmm11\n\t"                      \
         "ADD $2560,%[S2560B]\n\t"                                      \
         "SUB $1,%[i]\n\t"                                              \
         "JNE 2b\n\t"                                                   \
         "SUB $1,%[r]\n\t"                                              \
