				...
				do
					...
					do
						...
						do
							...
							codelet_name="${code}_2Sx${number_of_instructions}-${instruction}${flag_part}${swp_part}${dw_part}${stride_part}"
							...
							let "replace_consumed_elements = $nb_consumed_elements * 2"
