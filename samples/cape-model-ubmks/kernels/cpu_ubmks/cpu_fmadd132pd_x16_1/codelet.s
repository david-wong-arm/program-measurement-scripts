...
#	add $8, %rsi
	...
	.L6:
		...
		vfmadd132pd %ymm14, %ymm15, %ymm1
		vfmadd132pd %ymm14, %ymm15, %ymm2
		vfmadd132pd %ymm14, %ymm15, %ymm3
		vfmadd132pd %ymm14, %ymm15, %ymm4
		vfmadd132pd %ymm14, %ymm15, %ymm5
		vfmadd132pd %ymm14, %ymm15, %ymm6
		vfmadd132pd %ymm14, %ymm15, %ymm7
		vfmadd132pd %ymm14, %ymm15, %ymm8
		vfmadd132pd %ymm14, %ymm15, %ymm9
		vfmadd132pd %ymm14, %ymm15, %ymm10
		vfmadd132pd %ymm14, %ymm15, %ymm11
		vfmadd132pd %ymm14, %ymm15, %ymm12
		vfmadd132pd %ymm14, %ymm15, %ymm13
		vfmadd132pd %ymm14, %ymm14, %ymm0
		vfmadd132pd %ymm15, %ymm15, %ymm1
