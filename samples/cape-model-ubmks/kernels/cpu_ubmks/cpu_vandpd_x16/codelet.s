...
#	add $8, %rsi
	...
	.L6:
		...
		vandpd %ymm5, %ymm5, %ymm5
		vandpd %ymm6, %ymm6, %ymm6
		vandpd %ymm7, %ymm7, %ymm7
		vandpd %ymm8, %ymm8, %ymm8
		vandpd %ymm9, %ymm9, %ymm9
		vandpd %ymm10, %ymm10, %ymm10
		vandpd %ymm11, %ymm11, %ymm11
		vandpd %ymm12, %ymm12, %ymm12
		vandpd %ymm13, %ymm13, %ymm13
		vandpd %ymm14, %ymm14, %ymm14
