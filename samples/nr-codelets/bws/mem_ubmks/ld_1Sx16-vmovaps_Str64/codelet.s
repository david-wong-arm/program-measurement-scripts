...
#	add $8, %rsi
	...
	.L6:
		...
		vmovaps 64(%rsi,%r9,8), %ymm1
		vmovaps 128(%rsi,%r9,8), %ymm2
		vmovaps 192(%rsi,%r9,8), %ymm3
		vmovaps 256(%rsi,%r9,8), %ymm4
		vmovaps 320(%rsi,%r9,8), %ymm5
		vmovaps 384(%rsi,%r9,8), %ymm6
		vmovaps 448(%rsi,%r9,8), %ymm7

		vmovaps 512(%rsi,%r9,8), %ymm8
		vmovaps 576(%rsi,%r9,8), %ymm9
		vmovaps 640(%rsi,%r9,8), %ymm10
		vmovaps 704(%rsi,%r9,8), %ymm11
		vmovaps 768(%rsi,%r9,8), %ymm12
		vmovaps 832(%rsi,%r9,8), %ymm13
		vmovaps 896(%rsi,%r9,8), %ymm14
		vmovaps 960(%rsi,%r9,8), %ymm15
