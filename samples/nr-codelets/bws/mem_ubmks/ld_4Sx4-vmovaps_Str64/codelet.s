...
#	add $8, %rsi
	...
	.L6:
		...
		vmovaps 64(%rsi,%r8,8), %ymm1
		vmovaps 64(%rsi,%r12,8), %ymm1
		vmovaps 64(%rsi,%r13,8), %ymm1

		vmovaps 128(%rsi,%r9,8), %ymm2
		vmovaps 128(%rsi,%r8,8), %ymm2
		vmovaps 128(%rsi,%r12,8), %ymm2
		vmovaps 128(%rsi,%r13,8), %ymm2

		vmovaps 192(%rsi,%r9,8), %ymm3
		vmovaps 192(%rsi,%r8,8), %ymm3
		vmovaps 192(%rsi,%r12,8), %ymm3
		vmovaps 192(%rsi,%r13,8), %ymm3
