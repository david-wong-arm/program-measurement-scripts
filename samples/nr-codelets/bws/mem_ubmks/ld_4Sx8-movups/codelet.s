...
.DL1:
	...
	.L6:
		...
		movups 0(%rsi,%r8,8), %xmm0
		movups 0(%rsi,%r12,8), %xmm0
		movups 0(%rsi,%r13,8), %xmm0

		movups 16(%rsi,%r9,8), %xmm1
		movups 16(%rsi,%r8,8), %xmm1
		movups 16(%rsi,%r12,8), %xmm1
		movups 16(%rsi,%r13,8), %xmm1

		movups 32(%rsi,%r9,8), %xmm2
		movups 32(%rsi,%r8,8), %xmm2
		movups 32(%rsi,%r12,8), %xmm2
		movups 32(%rsi,%r13,8), %xmm2

		movups 48(%rsi,%r9,8), %xmm3
		movups 48(%rsi,%r8,8), %xmm3
		movups 48(%rsi,%r12,8), %xmm3
		movups 48(%rsi,%r13,8), %xmm3

		movups 64(%rsi,%r9,8), %xmm4
		movups 64(%rsi,%r8,8), %xmm4
		movups 64(%rsi,%r12,8), %xmm4
		movups 64(%rsi,%r13,8), %xmm4

		movups 80(%rsi,%r9,8), %xmm5
		movups 80(%rsi,%r8,8), %xmm5
		movups 80(%rsi,%r12,8), %xmm5
		movups 80(%rsi,%r13,8), %xmm5

		movups 96(%rsi,%r9,8), %xmm6
		movups 96(%rsi,%r8,8), %xmm6
		movups 96(%rsi,%r12,8), %xmm6
		movups 96(%rsi,%r13,8), %xmm6

		movups 112(%rsi,%r9,8), %xmm7
		movups 112(%rsi,%r8,8), %xmm7
		movups 112(%rsi,%r12,8), %xmm7
		movups 112(%rsi,%r13,8), %xmm7
