...
#	add $8, %rsi
	...
	.L6:
		...
		vmovaps %ymm0, 512(%rsi,%r9,8)
		vmovaps %ymm1, 544(%rsi,%r9,8)
		vmovaps %ymm2, 576(%rsi,%r9,8)
		vmovaps %ymm3, 608(%rsi,%r9,8)
		vmovaps %ymm4, 640(%rsi,%r9,8)
		vmovaps %ymm5, 672(%rsi,%r9,8)
		vmovaps %ymm6, 704(%rsi,%r9,8)
		vmovaps %ymm7, 736(%rsi,%r9,8)
		vmovaps %ymm8, 768(%rsi,%r9,8)
		vmovaps %ymm9, 800(%rsi,%r9,8)
		vmovaps %ymm10, 832(%rsi,%r9,8)
		vmovaps %ymm11, 864(%rsi,%r9,8)
		vmovaps %ymm12, 896(%rsi,%r9,8)
		vmovaps %ymm13, 928(%rsi,%r9,8)
		vmovaps %ymm14, 960(%rsi,%r9,8)
		vmovaps %ymm15, 992(%rsi,%r9,8)
