...
.DL1:
	...
	.L6:
		...
		vmovups 0(%rsi,%r8,8), %ymm0
		vmovups 0(%rsi,%r12,8), %ymm0
		vmovups 0(%rsi,%r13,8), %ymm0

		vmovups 32(%rsi,%r9,8), %ymm1
		vmovups 32(%rsi,%r8,8), %ymm1
		vmovups 32(%rsi,%r12,8), %ymm1
		vmovups 32(%rsi,%r13,8), %ymm1

		vmovups 64(%rsi,%r9,8), %ymm2
		vmovups 64(%rsi,%r8,8), %ymm2
		vmovups 64(%rsi,%r12,8), %ymm2
		vmovups 64(%rsi,%r13,8), %ymm2

		vmovups 96(%rsi,%r9,8), %ymm3
		vmovups 96(%rsi,%r8,8), %ymm3
		vmovups 96(%rsi,%r12,8), %ymm3
		vmovups 96(%rsi,%r13,8), %ymm3

		vmovups 128(%rsi,%r9,8), %ymm4
		vmovups 128(%rsi,%r8,8), %ymm4
		vmovups 128(%rsi,%r12,8), %ymm4
		vmovups 128(%rsi,%r13,8), %ymm4

        vmovups 160(%rsi,%r9,8), %ymm5
        vmovups 160(%rsi,%r8,8), %ymm5
        vmovups 160(%rsi,%r12,8), %ymm5
        vmovups 160(%rsi,%r12,8), %ymm5

        vmovups 192(%rsi,%r9,8), %ymm6
        vmovups 192(%rsi,%r8,8), %ymm6
        vmovups 192(%rsi,%r12,8), %ymm6
        vmovups 192(%rsi,%r13,8), %ymm6

        vmovups 224(%rsi,%r9,8), %ymm7
        vmovups 224(%rsi,%r8,8), %ymm7
        vmovups 224(%rsi,%r12,8), %ymm7
        vmovups 224(%rsi,%r13,8), %ymm7
