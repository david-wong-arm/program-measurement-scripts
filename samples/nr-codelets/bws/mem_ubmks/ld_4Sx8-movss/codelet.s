...
#	add $8, %rsi
	...
	.L6:
		...
		movss 0(%rsi,%r8,8), %xmm0
		movss 0(%rsi,%r12,8), %xmm0
		movss 0(%rsi,%r13,8), %xmm0

		movss 4(%rsi,%r9,8), %xmm1
		movss 4(%rsi,%r8,8), %xmm1
		movss 4(%rsi,%r12,8), %xmm1
		movss 4(%rsi,%r13,8), %xmm1

		movss 8(%rsi,%r9,8), %xmm2
		movss 8(%rsi,%r8,8), %xmm2
		movss 8(%rsi,%r12,8), %xmm2
		movss 8(%rsi,%r13,8), %xmm2

		movss 12(%rsi,%r9,8), %xmm3
		movss 12(%rsi,%r8,8), %xmm3
		movss 12(%rsi,%r12,8), %xmm3
		movss 12(%rsi,%r13,8), %xmm3

		movss 16(%rsi,%r9,8), %xmm4
		movss 16(%rsi,%r8,8), %xmm4
		movss 16(%rsi,%r12,8), %xmm4
		movss 16(%rsi,%r13,8), %xmm4

        movss 20(%rsi,%r9,8), %xmm5
        movss 20(%rsi,%r8,8), %xmm5
        movss 20(%rsi,%r12,8), %xmm5
        movss 20(%rsi,%r12,8), %xmm5

        movss 24(%rsi,%r9,8), %xmm6
        movss 24(%rsi,%r8,8), %xmm6
        movss 24(%rsi,%r12,8), %xmm6
        movss 24(%rsi,%r13,8), %xmm6

        movss 28(%rsi,%r9,8), %xmm7
        movss 28(%rsi,%r8,8), %xmm7
        movss 28(%rsi,%r12,8), %xmm7
        movss 28(%rsi,%r13,8), %xmm7
