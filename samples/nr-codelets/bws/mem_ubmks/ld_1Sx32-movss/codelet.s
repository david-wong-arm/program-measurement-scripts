...
#	add $8, %rsi
	...
	.L6:
		...
		movss 64(%rsi,%r9,8), %xmm0
		movss 68(%rsi,%r9,8), %xmm1
		movss 72(%rsi,%r9,8), %xmm2
		movss 76(%rsi,%r9,8), %xmm3
		movss 80(%rsi,%r9,8), %xmm4
		movss 84(%rsi,%r9,8), %xmm5
		movss 88(%rsi,%r9,8), %xmm6
		movss 92(%rsi,%r9,8), %xmm7
		movss 96(%rsi,%r9,8), %xmm8
		movss 100(%rsi,%r9,8), %xmm9
		movss 104(%rsi,%r9,8), %xmm10
		movss 108(%rsi,%r9,8), %xmm11
		movss 112(%rsi,%r9,8), %xmm12
		movss 116(%rsi,%r9,8), %xmm13
		movss 120(%rsi,%r9,8), %xmm14
		movss 124(%rsi,%r9,8), %xmm15
