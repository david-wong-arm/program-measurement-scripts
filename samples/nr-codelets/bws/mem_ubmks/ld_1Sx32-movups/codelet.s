...
.DL1:
	...
	.L6:
		...
		movups 256(%rsi,%r9,8), %xmm0
		movups 272(%rsi,%r9,8), %xmm1
		movups 288(%rsi,%r9,8), %xmm2
		movups 304(%rsi,%r9,8), %xmm3
		movups 320(%rsi,%r9,8), %xmm4
		movups 336(%rsi,%r9,8), %xmm5
		movups 352(%rsi,%r9,8), %xmm6
		movups 368(%rsi,%r9,8), %xmm7
		movups 384(%rsi,%r9,8), %xmm8
		movups 400(%rsi,%r9,8), %xmm9
		movups 416(%rsi,%r9,8), %xmm10
		movups 432(%rsi,%r9,8), %xmm11
		movups 448(%rsi,%r9,8), %xmm12
		movups 464(%rsi,%r9,8), %xmm13
		movups 480(%rsi,%r9,8), %xmm14
		movups 496(%rsi,%r9,8), %xmm15
