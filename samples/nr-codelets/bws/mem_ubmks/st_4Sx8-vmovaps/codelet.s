...
#	add $8, %rsi
	...
	.L6:
		...
		vmovaps %ymm0, 0(%rsi,%r8,8)
		vmovaps %ymm0, 0(%rsi,%r12,8)
		vmovaps %ymm0, 0(%rsi,%r13,8)

		vmovaps %ymm1, 32(%rsi,%r9,8)
		vmovaps %ymm1, 32(%rsi,%r8,8)
		vmovaps %ymm1, 32(%rsi,%r12,8)
		vmovaps %ymm1, 32(%rsi,%r13,8)

		vmovaps %ymm2, 64(%rsi,%r9,8)
		vmovaps %ymm2, 64(%rsi,%r8,8)
		vmovaps %ymm2, 64(%rsi,%r12,8)
		vmovaps %ymm2, 64(%rsi,%r13,8)

		vmovaps %ymm3, 96(%rsi,%r9,8)
		vmovaps %ymm3, 96(%rsi,%r8,8)
		vmovaps %ymm3, 96(%rsi,%r12,8)
		vmovaps %ymm3, 96(%rsi,%r13,8)

		vmovaps %ymm4, 128(%rsi,%r9,8)
		vmovaps %ymm4, 128(%rsi,%r8,8)
		vmovaps %ymm4, 128(%rsi,%r12,8)
		vmovaps %ymm4, 128(%rsi,%r13,8)

        vmovaps %ymm5, 160(%rsi,%r9,8)
        vmovaps %ymm5, 160(%rsi,%r8,8)
        vmovaps %ymm5, 160(%rsi,%r12,8)
        vmovaps %ymm5, 160(%rsi,%r12,8)

        vmovaps %ymm6, 192(%rsi,%r9,8)
        vmovaps %ymm6, 192(%rsi,%r8,8)
        vmovaps %ymm6, 192(%rsi,%r12,8)
        vmovaps %ymm6, 192(%rsi,%r13,8)

        vmovaps %ymm7, 224(%rsi,%r9,8)
        vmovaps %ymm7, 224(%rsi,%r8,8)
        vmovaps %ymm7, 224(%rsi,%r12,8)
        vmovaps %ymm7, 224(%rsi,%r13,8)
