...
#	add $8, %rsi
	...
	.L6:
		...
		movaps 0(%rsi,%r8,8), %xmm0
		movaps 0(%rsi,%r12,8), %xmm0
		movaps 0(%rsi,%r13,8), %xmm0

		movaps 16(%rsi,%r9,8), %xmm1
		movaps 16(%rsi,%r8,8), %xmm1
		movaps 16(%rsi,%r12,8), %xmm1
		movaps 16(%rsi,%r13,8), %xmm1

		movaps 32(%rsi,%r9,8), %xmm2
		movaps 32(%rsi,%r8,8), %xmm2
		movaps 32(%rsi,%r12,8), %xmm2
		movaps 32(%rsi,%r13,8), %xmm2

		movaps 48(%rsi,%r9,8), %xmm3
		movaps 48(%rsi,%r8,8), %xmm3
		movaps 48(%rsi,%r12,8), %xmm3
		movaps 48(%rsi,%r13,8), %xmm3

		movaps 64(%rsi,%r9,8), %xmm4
		movaps 64(%rsi,%r8,8), %xmm4
		movaps 64(%rsi,%r12,8), %xmm4
		movaps 64(%rsi,%r13,8), %xmm4

		movaps 80(%rsi,%r9,8), %xmm5
		movaps 80(%rsi,%r8,8), %xmm5
		movaps 80(%rsi,%r12,8), %xmm5
		movaps 80(%rsi,%r13,8), %xmm5

		movaps 96(%rsi,%r9,8), %xmm6
		movaps 96(%rsi,%r8,8), %xmm6
		movaps 96(%rsi,%r12,8), %xmm6
		movaps 96(%rsi,%r13,8), %xmm6

		movaps 112(%rsi,%r9,8), %xmm7
		movaps 112(%rsi,%r8,8), %xmm7
		movaps 112(%rsi,%r12,8), %xmm7
		movaps 112(%rsi,%r13,8), %xmm7
