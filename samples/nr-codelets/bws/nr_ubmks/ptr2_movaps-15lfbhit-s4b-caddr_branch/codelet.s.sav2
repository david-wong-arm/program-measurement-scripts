...
#		These 15 loads should hit LFB
		movsd		4(%rsi,%r9,1), %xmm3
		movsd		8(%rsi,%r9,1), %xmm4
		movsd		12(%rsi,%r9,1), %xmm5
		movsd		16(%rsi,%r9,1), %xmm6
		movsd		20(%rsi,%r9,1), %xmm7
		movsd		24(%rsi, %r9,1), %xmm8
		movsd		28(%rsi, %r9,1), %xmm9
		movsd		32(%rsi, %r9,1), %xmm10	
		movsd		36(%rsi, %r9,1), %xmm11
		movsd		40(%rsi, %r9,1), %xmm12
		movsd		44(%rsi, %r9,1), %xmm13
		movsd		48(%rsi, %r9,1), %xmm14
		movsd		52(%rsi, %r9,1), %xmm15
		movsd		56(%rsi, %r9,1), %xmm3
		movsd		60(%rsi, %r9,1), %xmm4

		movq		%xmm0, %rsi
	
		movsd		(%rcx, %r9,1), %xmm1
#		These 15 loads should hit LFB	
		movsd		4(%rcx, %r9,1), %xmm3
		movsd		8(%rcx, %r9,1), %xmm4
		movsd		12(%rcx, %r9,1), %xmm5
		movsd		16(%rcx, %r9,1), %xmm6
		movsd		20(%rcx, %r9,1), %xmm7
		movsd		24(%rcx, %r9,1), %xmm8
		movsd		28(%rcx, %r9,1), %xmm9
		movsd		32(%rcx, %r9,1), %xmm10
		movsd		36(%rcx, %r9,1), %xmm11
		movsd		40(%rcx, %r9,1), %xmm12
		movsd		44(%rcx, %r9,1), %xmm13
		movsd		48(%rcx, %r9,1), %xmm14
		movsd		52(%rcx, %r9,1), %xmm15
		movsd		56(%rcx, %r9,1), %xmm3
		movsd		60(%rcx, %r9,1), %xmm4
