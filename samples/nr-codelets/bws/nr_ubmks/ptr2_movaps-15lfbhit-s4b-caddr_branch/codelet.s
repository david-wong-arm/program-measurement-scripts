...
#		These 15 loads should hit LFB
		movss		4(%rsi,%r9,1), %xmm3
		movss		8(%rsi,%r9,1), %xmm4
		movss		12(%rsi,%r9,1), %xmm5
		movss		16(%rsi,%r9,1), %xmm6
		movss		20(%rsi,%r9,1), %xmm7
		movss		24(%rsi, %r9,1), %xmm8
		movss		28(%rsi, %r9,1), %xmm9
		movss		32(%rsi, %r9,1), %xmm10	
		movss		36(%rsi, %r9,1), %xmm11
		movss		40(%rsi, %r9,1), %xmm12
		movss		44(%rsi, %r9,1), %xmm13
		movss		48(%rsi, %r9,1), %xmm14
		movss		52(%rsi, %r9,1), %xmm15
		movss		56(%rsi, %r9,1), %xmm3
		movss		60(%rsi, %r9,1), %xmm4

		movq		%xmm0, %rsi
	
		movsd		(%rcx, %r9,1), %xmm1
#		These 15 loads should hit LFB	
		movss		4(%rcx, %r9,1), %xmm3
		movss		8(%rcx, %r9,1), %xmm4
		movss		12(%rcx, %r9,1), %xmm5
		movss		16(%rcx, %r9,1), %xmm6
		movss		20(%rcx, %r9,1), %xmm7
		movss		24(%rcx, %r9,1), %xmm8
		movss		28(%rcx, %r9,1), %xmm9
		movss		32(%rcx, %r9,1), %xmm10
		movss		36(%rcx, %r9,1), %xmm11
		movss		40(%rcx, %r9,1), %xmm12
		movss		44(%rcx, %r9,1), %xmm13
		movss		48(%rcx, %r9,1), %xmm14
		movss		52(%rcx, %r9,1), %xmm15
		movss		56(%rcx, %r9,1), %xmm3
		movss		60(%rcx, %r9,1), %xmm4
