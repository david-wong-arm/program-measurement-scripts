...
int main (int argc, char** argv)
{
	...
	glo_p9 = (struct item*) makeList(mem8, align, alignedSize, nb_elements_per_list);
	glo_p10 = (struct item*) makeList(mem9, align, alignedSize, nb_elements_per_list);
	glo_p11 = (struct item*) makeList(mem10, align, alignedSize, nb_elements_per_list);
