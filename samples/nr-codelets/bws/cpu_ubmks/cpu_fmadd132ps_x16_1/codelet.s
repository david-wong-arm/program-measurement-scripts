...
#	add $8, %rsi
	...
	.L6:
		...
		vfmadd132ps %ymm14, %ymm15, %ymm0
		vfmadd132ps %ymm14, %ymm15, %ymm1
		vfmadd132ps %ymm14, %ymm15, %ymm2
		vfmadd132ps %ymm14, %ymm15, %ymm3
		vfmadd132ps %ymm14, %ymm15, %ymm4
		vfmadd132ps %ymm14, %ymm15, %ymm5
		vfmadd132ps %ymm14, %ymm15, %ymm6
		vfmadd132ps %ymm14, %ymm15, %ymm7
		vfmadd132ps %ymm14, %ymm15, %ymm8
		vfmadd132ps %ymm14, %ymm15, %ymm9
		vfmadd132ps %ymm14, %ymm15, %ymm10
		vfmadd132ps %ymm14, %ymm15, %ymm11
		vfmadd132ps %ymm14, %ymm15, %ymm12
		vfmadd132ps %ymm14, %ymm15, %ymm13
		vfmadd132ps %ymm14, %ymm14, %ymm0
		vfmadd132ps %ymm15, %ymm15, %ymm1
