PROGRAM codelet_driver
 ...
 real*8, dimension (:, :), allocatable :: arg_c
 real*8, dimension (:, :), allocatable :: arg_d
 real*8 arg_g
 ...
 allocate (arg_c (arg_n, arg_n))
 allocate (arg_d (arg_n, arg_n))
 ...
 CALL measure_start()
 do i = 1, repeat_value
	CALL codelet (arg_n, arg_n, arg_a, arg_b, arg_c, arg_d, arg_i, arg_g)
 end do
 CALL measure_stop()
