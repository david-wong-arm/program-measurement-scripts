...
int main (int argc, char** argv)
{
	...
	double (*arg_v)[arg_n] = (double(*)[arg_n]) buf;
        //double *pp = (double*) buf;
	unsigned long long alignedSize_b = alignUp(sizeof(double)* arg_n, align);
	char* buf_x = malloc (alignedSize_b);
	double *arg_x = (double*) buf_x;
	char* buf_tmp = malloc (alignedSize_b);
	double *arg_tmp = (double*) buf_tmp;
	...
	memset (arg_v, 0, arg_n*arg_n * sizeof(double));
	memset (arg_x, 0, arg_n * sizeof(double));
	memset (arg_tmp, 0, arg_n * sizeof(double));
